...
/*   Updated: 2024/02/19 14:46:02 by gyoon            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    ...
    void setHttpConfigCore(const ConfigFile::directives_t &directives) throw(
        std::logic_error);
...
std::ostream &operator<<(std::ostream &os,
                         const Hafserv::AHttpConfigCore &conf);
std::ostream &operator<<(std::ostream &os,
                         const Hafserv::AHttpConfigCore::Timeout &timeouts);
